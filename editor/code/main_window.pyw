...
class MainWindow(wx.Frame):
    ...
    def __init__(self, parent, title):
        ...
        self.SetIcon(wx.Icon(self.IMAGE_PATH + 'icon.ico'))
        ...
        if self.project is None:
            ...
            if result == wx.ID_YES:
                ...
                if result == wx.ID_OK:
                    ...
                    self.project = Project(self.save_project_dd.GetPath(), self.BOT_PATH)
    ...
    def onCreateClick(self, event):
        ...
        if may_continue:
            ...
            if result == wx.ID_OK:
                ...
                self.project = Project(path, self.BOT_PATH)
                self.updateUI()
